 ...
 * @author feifz
 * @version 1.0.0
 * @Description MQProducer 订阅消息的发送者
 * @Date 2019/1/4 10:17
 */
import com.ohaotian.feifz.style.study.constant.Constants;
...
public class MQProducer {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            // 创建TextMessage消息
            TextMessage message = session.createTextMessage("hello，这是我发布的第一条topic消息！");
            // 发布消息
